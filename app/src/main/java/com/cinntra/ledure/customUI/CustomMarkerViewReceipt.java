...
public class CustomMarkerViewReceipt extends MarkerView {

    private TextView tvContent;
    private List<String> dayList;
    private List<String> secondDayList; // Second list for the second dataset

    public CustomMarkerViewReceipt(Context context, int layoutResource, List<String> dayList, List<String> secondDayList) {
