...
import com.cinntra.ledure.activities.AddCampaign;
import com.cinntra.ledure.activities.AddContact;
import com.cinntra.ledure.activities.AddLead;
...
import com.cinntra.ledure.databinding.FragmentPurchaseBinding;
...
*/
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        leadDropDownAdapter = new LeadDropDownAdapter(getActivity(), leadValueList);
...
//        setSupportActionBar(toolbar);
        ...
        dateSpinnerAdapter = ArrayAdapter.createFromResource(getContext(),
...
// Set the adapter for the Spinner
        ...
        binding.zoneLayout.setOnClickListener(new View.OnClickListener() {
            @Override
     ...
     /*   if (MainBaseActivity.boolean_permission) {
        ...
        binding.contentData.linearDate.setOnClickListener(bind -> {
            showDateInDashboardBottomSheetDialog(getContext());
        });
        ...
        binding.contentData.pendingOrderCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), PendingOrders.class));
        ...
        binding.contentData.salesAmountCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(getActivity(), Sale_Inovice_Reports.class));
     ...
     /*   binding.contentData.newtypeCard.setOnClickListener(new View.OnClickListener() {
      ...
      /*  BottomNavigationView navigationView = getContext().findViewById(R.id.navigationView);
...
//                startActivity(new Intent(getActivity(),Reports.class));
        ...
        call.enqueue(new Callback<LeadResponse>() {
            ...
            public void onResponse(Call<LeadResponse> call, Response<LeadResponse> response) {
                if (response.code() == 200) {
                    ...
                    //  LeadDropDownAdapter leadAdapter = new LeadDropDownAdapter(getActivity(), leadValueList);
                    lead_spiner.setAdapter(new ArrayAdapter<>(getActivity(), android.R.layout.simple_spinner_item, itemNames));
    ...
    private void callBplistApi(Spinner bp_spinner, Spinner cp_spinner) {
        ...
        model.getCustomersList(binding.contentData.loader.loader).observe(getActivity(), new Observer<List<BusinessPartnerData>>() {
            @Override
            public void onChanged(@Nullable List<BusinessPartnerData> itemsList) {
                ...
                if (itemsList.size() >= 0) {
                    ...
                    //  bp_spinner.setAdapter(new BPDropdownAdapter(getActivity(), AllitemsList));
                    bp_spinner.setAdapter(new ArrayAdapter<>(getActivity(), android.R.layout.simple_spinner_item, itemNames));
...
//        Call<AttachmentModel> call = NewApiClient.getInstance().getApiService(getActivity()).getAllAttachment(jsonObject);
    ...
    private void showBottomSheetDialog() {
        ...
        ZonesAdapter adapter = new ZonesAdapter(getContext(), result, "ShowDetails");
    ...
    private void setupChartViewPgaer() {
        graphPagerAdapter = new GraphPagerAdapter(getContext());
...
//                    binding.contentData.tabLayout.setTabTextColors(ColorStateList.valueOf(getResources().getColor(R.color.white)));
    ...
    private void opencheckinDialog() {
        ...
        modeOfTransportAdapter = ArrayAdapter.createFromResource(getActivity(), transportType, android.R.layout.simple_spinner_item);
        ...
        expenseAdapter = ArrayAdapter.createFromResource(getActivity(), R.array.type_of_expense_list, android.R.layout.simple_spinner_item);
...
// Start the activity and wait for the user to pick a file
        ...
        lead_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(getActivity(), addLead.getClass()));
            }
        });
...
//                }
        ...
        prospectbp_spinner.setAdapter(new BPDropdownAdapter(getActivity(), filterprospect(AllitemsList)));
...
//                    }
//                    else {
//                        Toast.makeText(getActivity(), "inside expense", Toast.LENGTH_SHORT).show();
//
//                        mapData.setExpenseType(expenseString);
//                        mapData.setExpenseCost(costSt);
//                        mapData.setExpenseDistance(distanceSt);
...
//                        mapData.setAttach("");
                        ...
                        Toasty.warning(getActivity(), "Please Fill document Carefully").show();
                    }
                }
...
//                    checkInDate, CheckInTime, checkInLat, checkInLong, checkinRemark);
    ...
    private boolean validation(EditText companyname, EditText full_name, EditText attachFile, EditText remarkExpense, EditText tripName) {
        ...
        if (companyname.length() == 0) {
            ...
            Toasty.warning(getActivity(), "Enter Cost ", Toast.LENGTH_SHORT).show();
            return false;
        } else if (full_name.length() == 0) {
            full_name.requestFocus();
            full_name.setError("Enter Distance");
            Toasty.warning(getActivity(), "Enter Distance", Toast.LENGTH_SHORT).show();

            return false;
        } else if (attachFile.length() == 0) {
            attachFile.requestFocus();
            attachFile.setError("Choose File");
            Toasty.warning(getActivity(), "Choose File", Toast.LENGTH_SHORT).show();

            return false;
        } else if (remarkExpense.length() == 0) {
            attachFile.requestFocus();
            attachFile.setError("Enter Remark");
            Toasty.warning(getActivity(), "Enter Remark", Toast.LENGTH_SHORT).show();

            return false;
        } else if (tripName.length() == 0) {
            tripName.requestFocus();
            tripName.setError("Enter Trip Name");
            Toasty.warning(getActivity(), "Enter Trip Name", Toast.LENGTH_SHORT).show();
    ...
    private boolean validateCheckIn(EditText attachment, EditText remarks) {
        ...
        if (attachment.length() == 0) {
            ...
            Toasty.warning(getActivity(), "Please Attach Document ", Toast.LENGTH_SHORT).show();
            return false;
        } else if (remarks.length() == 0) {
            remarks.requestFocus();
            remarks.setError("Enter Remarks");
            Toasty.warning(getActivity(), "Enter Remarks", Toast.LENGTH_SHORT).show();
    ...
    private void callCheckInApi(MultipartBody.Part imagePart,
        ...
        Call<ResponseTripCheckIn> call = NewApiClient.getInstance().getApiService(getActivity()).tripCheckIn(
    ...
    private void callCheckOutApi(MultipartBody.Part imagePart,
        ...
        Call<ResponseTripCheckOut> call = NewApiClient.getInstance().getApiService(getActivity()).tripCheckOut(
                ...
                if (response != null) {
                    ...
                    if (response.code() == 200) {
                        ...
                        Call<ExpenseResponse> callExp = NewApiClient.getInstance()
                                .getApiService(getActivity()).expense_create_multipart(imagePart, id, tripName, typeOfExpense,
...
//                                                .getLongitude(), mapData, address);
                                        ...
                                        //   Toast.makeText(getActivity(), "" + location1.getLatitude() + "" + location1.getLongitude(), Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(Call<ContactPerson> call, Response<ContactPerson> response) {
                ...
                if (response.code() == 200) {
                    if (response.body().getData().size() > 0) {
                        ...
                        cp_spinner.setAdapter(new ContactPersonAdapter(getActivity(), ContactEmployeesList));
                    }
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i) {
                    ...
                    case R.id.rbTravel:
                        ...
                        Toast.makeText(getActivity(), "Your Trip has been started", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
...
// Start the activity and wait for the user to pick a file
        ...
        editTextExpenseFrom.setOnClickListener(view -> {
            ...
            Globals.selectDate(getActivity(), editTextExpenseFrom);
        });

        editTextExpenseTo.setOnClickListener(view -> {

            Globals.selectDate(getActivity(), editTextExpenseTo);
        });
...
//        xAxis.setValueFormatter(new PurchaseFragment().ClaimsXAxisValueFormatter(dates));
        ...
        call.enqueue(new Callback<EventResponse>() {
            ...
            public void onResponse(Call<EventResponse> call, Response<EventResponse> response) {
                if (response.code() == 200) {
                    ...
                    adapter = new RecentAdapter(getActivity(), recentlist);
                    binding.contentData.cominguprecyvlerview.setLayoutManager(new LinearLayoutManager(getActivity(), RecyclerView.HORIZONTAL, false));
                    binding.contentData.recentrecyvlerview.setLayoutManager(new LinearLayoutManager(getActivity(), RecyclerView.HORIZONTAL, false));
        ...
        call.enqueue(new Callback<QuotationResponse>() {
            ...
            public void onResponse(Call<QuotationResponse> call, Response<QuotationResponse> response) {
                if (response.code() == 200) {
                    ...
                    RecentOrderAdapter adapter = new RecentOrderAdapter(getActivity(), recenOrdertlist);
                    binding.contentData.recentrecyvlerview.setLayoutManager(new LinearLayoutManager(getActivity(), RecyclerView.HORIZONTAL, false));
                    binding.contentData.recentrecyvlerview.setAdapter(adapter);
...
//                .setTextTypeface(Typeface.createFromAsset(getAssets(), "poppins_regular.ttf"))
                ...
                .setWidth(Globals.pxFromDp(getContext(), 220f))
            ...
            public void onItemClick(int position, PowerMenuItem item) {
                ...
                switch (position) {
                    ...
                    case 0:
                        ...
                        startActivity(new Intent(getActivity(), AddLead.class));
                        break;
                    case 1:
                        Prefs.putString(Globals.SelectOpportnity, "Dashboard");
                        startActivity(new Intent(getActivity(), AddOpportunityActivity.class));
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        Intent i = new Intent(getActivity(), AddQuotationAct.class);
                        startActivity(i);
                        break;
                    case 4:
                        Prefs.putString(Globals.FromQuotation, "Order");
                        startActivity(new Intent(getActivity(), AddOrderAct.class));
                        break;
                    case 5:
                        startActivity(new Intent(getActivity(), AddCampaign.class));
                        break;
...
*/
    ...
    private void saleGraphApi() {
        ...
        Call<SalesGraphResponse> call = NewApiClient.getInstance().getApiService(getActivity()).salesGraph(obj);
    ...
    private void ReceiptGraphApi() {
        ...
        Call<SalesGraphResponse> call = NewApiClient.getInstance().getApiService(getActivity()).receiptGraph(obj);
        call.enqueue(new Callback<SalesGraphResponse>() {
            @Override
            public void onResponse(Call<SalesGraphResponse> call, Response<SalesGraphResponse> response) {
                if (response != null) {
    ...
    private void ReceivableGraphApi() {
       ...
       /* {
        ...
        Call<ResponseReceivableGraph> call = NewApiClient.getInstance().getApiService(getActivity()).receivableDueMonthGraph(obj);
