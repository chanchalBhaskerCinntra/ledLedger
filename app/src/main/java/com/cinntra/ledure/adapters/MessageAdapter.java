...
public class MessageAdapter extends RecyclerView.Adapter<com.cinntra.ledure.adapters.MessageAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.cinntra.ledure.adapters.MessageAdapter.ViewHolder(rootView);
    }
