...
*/
    ...
    public static void createWebPrintJob(final Activity activity, final WebView webView, final File directory, final String fileName, final Callback callback) {
        // Ensure this code runs on the main thread
        activity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                // Check the marshmallow permissions
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
