...
public class AssignedTo implements Parcelable
{
    ...
    public final static Creator<AssignedTo> CREATOR = new Creator<AssignedTo>() {
        ...
        public com.cinntra.ledure.newapimodel.AssignedTo createFromParcel(android.os.Parcel in) {
            return new com.cinntra.ledure.newapimodel.AssignedTo(in);
        }

        public com.cinntra.ledure.newapimodel.AssignedTo[] newArray(int size) {
            return (new com.cinntra.ledure.newapimodel.AssignedTo[size]);
        }
