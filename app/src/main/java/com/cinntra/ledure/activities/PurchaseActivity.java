...
import com.cinntra.ledure.databinding.ActivityPurchaseBinding;
...
public class PurchaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        leadDropDownAdapter = new LeadDropDownAdapter(PurchaseActivity.this, leadValueList);
        client = LocationServices.getFusedLocationProviderClient(PurchaseActivity.this);
...
//        binding.tvClientName.setText("Welcome " + Prefs.getString(Globals.USER_NAME, ""));
        binding.tvClientName.setText("Purchase");
...
// Set the adapter for the Spinner
     ...
     /*   if (MainBaseActivity.boolean_permission) {
        ...
        binding.contentData.pendingOrderCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PurchaseActivity.this, PendingOrders.class));
            ...
            /*    if (Prefs.getString(Globals.Role, "").trim().equalsIgnoreCase("admin") || Prefs.getString(Globals.Role, "").trim().equalsIgnoreCase("Director") || Prefs.getString(Globals.Role, "").trim().equalsIgnoreCase("Accounts")) {
                    ...
                    Toast.makeText(PurchaseActivity.this, "Under Maintenance", Toast.LENGTH_SHORT).show();
                }*/
            }
        });
        ...
        binding.contentData.receivedCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(PurchaseActivity.this, Reports.class));
        ...
        binding.contentData.salesAmountCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Prefs.putString("ForReports", "PurchaseActivity_Ledger");
                startActivity(new Intent(PurchaseActivity.this, Sale_Inovice_Reports.class));
     ...
     /*   binding.contentData.newtypeCard.setOnClickListener(new View.OnClickListener() {
        ...
        binding.proImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(PurchaseActivity.this, ProfileActivity.class);
                startActivity(i);
            }
        });
...
//                startActivity(new Intent(PurchaseActivity.this,Reports.class));
    ...
    private void callDashboardCounter_Receiable() {
        ...
        call.enqueue(new Callback<DashboardCounterResponse>() {
            ...
            public void onFailure(Call<DashboardCounterResponse> call, Throwable t) {
                ...
                Toast.makeText(PurchaseActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        call.enqueue(new Callback<LeadResponse>() {
            ...
            public void onResponse(Call<LeadResponse> call, Response<LeadResponse> response) {
                if (response.code() == 200) {
                    ...
                    //  LeadDropDownAdapter leadAdapter = new LeadDropDownAdapter(PurchaseActivity.this, leadValueList);
                    lead_spiner.setAdapter(new ArrayAdapter<>(PurchaseActivity.this, android.R.layout.simple_spinner_item, itemNames));
    ...
    private void callBplistApi(Spinner bp_spinner, Spinner cp_spinner) {
        CustomerViewModel model = ViewModelProviders.of(PurchaseActivity.this).get(CustomerViewModel.class);
        model.getCustomersList(binding.contentData.loader.loader).observe(PurchaseActivity.this, new Observer<List<BusinessPartnerData>>() {
            @Override
            public void onChanged(@Nullable List<BusinessPartnerData> itemsList) {
                ...
                if (itemsList.size() >= 0) {
                    ...
                    //  bp_spinner.setAdapter(new BPDropdownAdapter(PurchaseActivity.this, AllitemsList));
                    bp_spinner.setAdapter(new ArrayAdapter<>(PurchaseActivity.this, android.R.layout.simple_spinner_item, itemNames));
            ...
            public void onResponse(Call<AttachmentModel> call, Response<AttachmentModel> response) {
                if (response != null) {
                    ...
                    if (response.code() == 200) {
                        ...
                        Toast.makeText(PurchaseActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
...
//                    binding.contentData.tabLayout.setTabTextColors(ColorStateList.valueOf(getResources().getColor(R.color.white)));
    ...
    private void opencheckinDialog() {
        ...
        modeOfTransportAdapter = ArrayAdapter.createFromResource(PurchaseActivity.this, transportType, android.R.layout.simple_spinner_item);
        ...
        expenseAdapter = ArrayAdapter.createFromResource(PurchaseActivity.this, R.array.type_of_expense_list, android.R.layout.simple_spinner_item);
...
// Start the activity and wait for the user to pick a file
        ...
        lead_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(PurchaseActivity.this, addLead.getClass()));
            }
        });
...
//                }
        ...
        prospectbp_spinner.setAdapter(new BPDropdownAdapter(PurchaseActivity.this, filterprospect(AllitemsList)));
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rbExpense.isChecked()) {
                    //   Toast.makeText(PurchaseActivity.this, "expense", Toast.LENGTH_SHORT).show();
...
//                    }
//                    else {
//                        Toast.makeText(PurchaseActivity.this, "inside expense", Toast.LENGTH_SHORT).show();
//
//                        mapData.setExpenseType(expenseString);
//                        mapData.setExpenseCost(costSt);
//                        mapData.setExpenseDistance(distanceSt);
...
//                        mapData.setAttach("");
                        ...
                        Toasty.warning(PurchaseActivity.this, "Please Fill document Carefully").show();
                    }
                }
...
//                    checkInDate, CheckInTime, checkInLat, checkInLong, checkinRemark);
    ...
    private boolean validation(EditText companyname, EditText full_name, EditText attachFile, EditText remarkExpense, EditText tripName) {
        ...
        if (companyname.length() == 0) {
            ...
            Toasty.warning(PurchaseActivity.this, "Enter Cost ", Toast.LENGTH_SHORT).show();
            return false;
        } else if (full_name.length() == 0) {
            full_name.requestFocus();
            full_name.setError("Enter Distance");
            Toasty.warning(PurchaseActivity.this, "Enter Distance", Toast.LENGTH_SHORT).show();

            return false;
        } else if (attachFile.length() == 0) {
            attachFile.requestFocus();
            attachFile.setError("Choose File");
            Toasty.warning(PurchaseActivity.this, "Choose File", Toast.LENGTH_SHORT).show();

            return false;
        } else if (remarkExpense.length() == 0) {
            attachFile.requestFocus();
            attachFile.setError("Enter Remark");
            Toasty.warning(PurchaseActivity.this, "Enter Remark", Toast.LENGTH_SHORT).show();

            return false;
        } else if (tripName.length() == 0) {
            tripName.requestFocus();
            tripName.setError("Enter Trip Name");
            Toasty.warning(PurchaseActivity.this, "Enter Trip Name", Toast.LENGTH_SHORT).show();
    ...
    private boolean validateCheckIn(EditText attachment, EditText remarks) {
        ...
        if (attachment.length() == 0) {
            ...
            Toasty.warning(PurchaseActivity.this, "Please Attach Document ", Toast.LENGTH_SHORT).show();
            return false;
        } else if (remarks.length() == 0) {
            remarks.requestFocus();
            remarks.setError("Enter Remarks");
            Toasty.warning(PurchaseActivity.this, "Enter Remarks", Toast.LENGTH_SHORT).show();
    ...
    private void getmyCurrentLocation(MapData mapData) {
        ...
        LocationManager locationManager
                = (LocationManager) PurchaseActivity.this
                .getSystemService(
                    ...
                    new OnCompleteListener<Location>() {
                        ...
                        public void onComplete(
                            ...
                            if (location != null) {
                                ...
                                geocoder = new Geocoder(PurchaseActivity.this, Locale.getDefault());
                        ...
                        callExp.enqueue(new Callback<ExpenseResponse>() {
                            ...
                            public void onResponse(Call<ExpenseResponse> call, Response<ExpenseResponse> response) {
                                if (response != null && response.code() == 200) {
                                    attachmentcheckOut = "";
                                    Toast.makeText(PurchaseActivity.this, "Expense Added", Toast.LENGTH_SHORT).show();
                                    dialog.dismiss();
...
//                                        .getLongitude(), mapData, address);
                                ...
                                //    Toast.makeText(PurchaseActivity.this, "" + location.getLatitude() + "" + location.getLongitude(), Toast.LENGTH_SHORT).show();
...
//                                                .getLongitude(), mapData, address);
                                        ...
                                        //   Toast.makeText(PurchaseActivity.this, "" + location1.getLatitude() + "" + location1.getLongitude(), Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(Call<ContactPerson> call, Response<ContactPerson> response) {
                ...
                if (response.code() == 200) {
                    if (response.body().getData().size() > 0) {
                        ...
                        cp_spinner.setAdapter(new ContactPersonAdapter(PurchaseActivity.this, ContactEmployeesList));
                    }
                    ...
                    try {
                        ...
                        Toast.makeText(PurchaseActivity.this, mError.getError().getMessage().getValue(), Toast.LENGTH_LONG).show();
                    } catch (IOException e) {
                        //handle failure to read error
                    }
                    //Toast.makeText(CreateContact.this, msz, Toast.LENGTH_SHORT).show();
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i) {
                    ...
                    case R.id.rbTravel:
                        ...
                        Toast.makeText(PurchaseActivity.this, "Your Trip has been started", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
...
// Start the activity and wait for the user to pick a file
        ...
        editTextExpenseFrom.setOnClickListener(view -> {
            ...
            Globals.selectDate(PurchaseActivity.this, editTextExpenseFrom);
        });

        editTextExpenseTo.setOnClickListener(view -> {

            Globals.selectDate(PurchaseActivity.this, editTextExpenseTo);
        });
    ...
    private void opengraph() {
        ...
        xAxis.setValueFormatter(new PurchaseActivity.ClaimsXAxisValueFormatter(dates));
...
//        xAxis.addLimitLine(ll2);
    ...
    private void givepermission() {
        Dexter.withActivity(PurchaseActivity.this)
                .withPermissions(
    ...
    private void callCountryApi() {
        ...
        call.enqueue(new Callback<CountryResponse>() {
            ...
            public void onFailure(Call<CountryResponse> call, Throwable t) {
                Toast.makeText(PurchaseActivity.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        call.enqueue(new Callback<EventResponse>() {
            ...
            public void onResponse(Call<EventResponse> call, Response<EventResponse> response) {
                if (response.code() == 200) {
                    ...
                    adapter = new RecentAdapter(PurchaseActivity.this, recentlist);
                    binding.contentData.cominguprecyvlerview.setLayoutManager(new LinearLayoutManager(PurchaseActivity.this, RecyclerView.HORIZONTAL, false));
                    binding.contentData.recentrecyvlerview.setLayoutManager(new LinearLayoutManager(PurchaseActivity.this, RecyclerView.HORIZONTAL, false));
        ...
        call.enqueue(new Callback<QuotationResponse>() {
            ...
            public void onResponse(Call<QuotationResponse> call, Response<QuotationResponse> response) {
                if (response.code() == 200) {
                    ...
                    RecentOrderAdapter adapter = new RecentOrderAdapter(PurchaseActivity.this, recenOrdertlist);
                    binding.contentData.recentrecyvlerview.setLayoutManager(new LinearLayoutManager(PurchaseActivity.this, RecyclerView.HORIZONTAL, false));
                    binding.contentData.recentrecyvlerview.setAdapter(adapter);
            ...
            public void onItemClick(int position, PowerMenuItem item) {
                ...
                switch (position) {
                    ...
                    case 0:
                        ...
                        startActivity(new Intent(PurchaseActivity.this, AddLead.class));
                        break;
                    case 1:
                        Prefs.putString(Globals.SelectOpportnity, "Dashboard");
                        startActivity(new Intent(PurchaseActivity.this, AddOpportunityActivity.class));
                        break;
                    case 2:
                        Intent intent = new Intent(PurchaseActivity.this, AddContact.class);
                    ...
                    case 3:
                        ...
                        Intent i = new Intent(PurchaseActivity.this, AddQuotationAct.class);
                        startActivity(i);
                        break;
                    case 4:
                        Prefs.putString(Globals.FromQuotation, "Order");
                        startActivity(new Intent(PurchaseActivity.this, AddOrderAct.class));
                        break;
                    case 5:
                        startActivity(new Intent(PurchaseActivity.this, AddCampaign.class));
                        break;
