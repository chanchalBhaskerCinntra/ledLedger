...
import com.cinntra.ledure.adapters.ItemListSelectingCategoryFromZoneAdapter;
...
import com.cinntra.ledure.databinding.ActivityItemListFromSelectingCategoryFromZoneBinding;
...
public class ItemListFromSelectingCategoryFromZoneActivity extends AppCompatActivity {

    private ActivityItemListFromSelectingCategoryFromZoneBinding binding;
    String fromwhere = "";
    // ItemOnDashboardAdapter adapter;
    ItemListSelectingCategoryFromZoneAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityItemListFromSelectingCategoryFromZoneBinding.inflate(getLayoutInflater());
       ...
       /* if (startDate.isEmpty()) {
        ...
        binding.toolbarItemDashBoard.relativeCalView.setOnClickListener(view -> {
            showDateBottomSheetDialog(ItemListFromSelectingCategoryFromZoneActivity.this);
        });
            ...
            public void run() {
               ...
               /* if (fromwhere.equalsIgnoreCase("from")) {
                ...
                if (Prefs.getBoolean(Globals.ISPURCHASE, false)) {
                    call = NewApiClient.getInstance().getApiService(ItemListFromSelectingCategoryFromZoneActivity.this).getItemOnDashboardPurchase(hde);
                } else {
                    call = NewApiClient.getInstance().getApiService(ItemListFromSelectingCategoryFromZoneActivity.this).getItemOnDashboard(hde);
                }
                try {
                        ...
                        handler.post(new Runnable() {
                            ...
                            public void run() {
                                if (response.code() == 200) {
                                    ...
                                    adapter = new ItemListSelectingCategoryFromZoneAdapter(ItemListFromSelectingCategoryFromZoneActivity.this, AllitemsList, zoneCode, groupFilter);
                                    adapter.AllData(AllitemsList);
                                    layoutManager = new LinearLayoutManager(ItemListFromSelectingCategoryFromZoneActivity.this, RecyclerView.VERTICAL, false);
